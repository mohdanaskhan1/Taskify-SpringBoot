...
public class AuthService {
    ...
    private LoginResponseDTO generateTokens(UserEntity user) {
    ...
    public LoginResponseDTO refreshToken(String refreshToken) {
        ...
        // For simple refresh, we just issue a new Access Token.
        // We can reuse the old refresh token or rotate it. Here we just return the new access token.
